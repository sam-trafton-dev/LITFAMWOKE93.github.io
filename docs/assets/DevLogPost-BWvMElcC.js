...
end`}),e.jsx("h2",{children:"The Payoff"}),e.jsx("p",{children:`After about a week of obsessive work, I published "Dynamic Imposter's Dome Lights" to the Steam Workshop. Players could finally read, craft, and do anything else inside their vehicles at night.`}),e.jsx("p",{children:"The funny part? A few months later, the developers added official interior lighting to vehicles. My mod became deprecated. But that wasn't the point."}),e.jsx("h2",{children:"Why This Matters"}),e.jsxs("p",{children:["This project taught me something important about how I work. When I see something broken—something that ",e.jsx("em",{children:"should"}),` work but doesn't—a switch flips in my brain. It's not about the size of the problem or whether anyone else cares. It's about the gap between "what is" and "what should be."`]}),e.jsx("p",{children:"That gap is where I live. Whether it's a missing feature in a game, a bug in production code, or a manual process that should be automated—once I see it, I can't unsee it. And I won't rest until it's fixed."}),e.jsx("p",{children:"Some people might call that obsessive. I call it engineering."})]})}const I={"engineering-mindset-dome-lights":e.jsx(k,{}),"building-my-portfolio-site":e.jsx(v,{}),"github-actions-ci-cd":e.jsx(y,{})};function N(){const{slug:s}=m(),i=s?x(s):void 0;if(!i)return e.jsx(g,{to:"/devlog",replace:!0});const d=I[i.slug],c=n=>new Date(n).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return e.jsxs("div",{className:"min-h-screen bg-background",children:[e.jsx("div",{className:"pt-24 pb-4 px-4",children:e.jsx("div",{className:"container mx-auto max-w-4xl",children:e.jsx(a,{variant:"ghost",asChild:!0,className:"gap-2 -ml-4",children:e.jsxs(o,{to:"/devlog",children:[e.jsx(r,{className:"h-4 w-4"}),"Back to DevLog"]})})})}),e.jsx("header",{className:"pb-8 px-4 border-b border-border",children:e.jsxs("div",{className:"container mx-auto max-w-4xl",children:[e.jsxs("div",{className:"flex items-center gap-2 text-sm text-muted-foreground mb-4",children:[e.jsx(j,{className:"h-4 w-4"}),c(i.date)]}),e.jsx("h1",{className:"text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6",children:i.title}),e.jsx("div",{className:"flex flex-wrap gap-2",children:i.tags.map(n=>e.jsxs(u,{variant:"secondary",className:"gap-1",children:[e.jsx(f,{className:"h-3 w-3"}),n]},n))})]})}),e.jsx("main",{className:"py-12 px-4",children:e.jsx("div",{className:"container mx-auto max-w-4xl",children:d||e.jsx("p",{className:"text-muted-foreground",children:"Content coming soon..."})})}),e.jsx("footer",{className:"py-12 px-4 border-t border-border",children:e.jsx("div",{className:"container mx-auto max-w-4xl text-center",children:e.jsx(a,{variant:"outline",asChild:!0,children:e.jsxs(o,{to:"/devlog",children:[e.jsx(r,{className:"mr-2 h-4 w-4"}),"Back to all posts"]})})})})]})}export{N as default};
