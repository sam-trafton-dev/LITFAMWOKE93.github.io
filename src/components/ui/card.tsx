...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border-2 border-border bg-card text-card-foreground transition-all hover:border-primary/50 hover:shadow-[0_0_15px_hsl(38_100%_50%/0.2)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl font-terminal uppercase tracking-wider text-primary",
      className
    )}
    {...props}
  />
